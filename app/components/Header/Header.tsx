    ...
    <>
      ...
      >
        <div className="container">
          <section className={s.Wrapper}>
            {/* Left / main content */}
            <NavbarContent className="w-full !gap-0 !justify-between">
              <Link
                className={s.Logo}
                href="/"
                onClick={() => setIsMenuOpen(false)}
            ...
            {/* ToggleMenu */}
            <NavbarMenu className="z-index2000 border-t-1 border-gray/10 bg-white dark:bg-black">
              {/* Menu header */}
              <div className={s.MenuHeader}>
                <div className={s.MenuHeaderGradient} />
                <div className={s.MenuHeaderIcon}>
              ...
              <Accordion isCompact className={s.Accordion}>
                {DATA_TOGGLE_MENU_LINKS.map((item, i) => (
                  ...
                  >
                    <NavbarMenuItem className={s.MenuItemGrid}>
